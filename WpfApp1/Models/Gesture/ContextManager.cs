...
public class ContextManager : ContextManagerAbs, IDisposable
{
    ...
    private async Task<bool> EvaluateAsync(EvaluationContext evalContext, IReadOnlyWhenElement whenElement)
    {
