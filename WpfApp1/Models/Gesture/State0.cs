...
public class State0 : State
{
    ...
    public State0(GestureMachineAbs machine, IReadOnlyRootElement rootElement) : base(0)
    {
        Machine = machine;
            ...
            if (IsDoubleThrowTrigger(pressEvent))
            {
                ...
                if (doubleThrowElements.Any())
                {
                    ...
                    var nextState = new StateN(
                        ...
                        Depth + 1,
                        true);
                    return StateResult.Create(true, nextState);
                }
            }
