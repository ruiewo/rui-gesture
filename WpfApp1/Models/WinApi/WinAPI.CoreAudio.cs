...
public class VolumeControl : IDisposable
{
    ...
    internal static Guid MMDeviceEnumerator = new("BCDE0395-E52F-467C-8E3D-C4579291692E");
    ...
    internal IAudioEndpointVolume GetAudioEndpointVolume()
    {
        ...
        {
            object endpoint;
            Marshal.ThrowExceptionForHR(speakers.Activate(ref IID_IAudioEndpointVolume, (int)CLSCTX.CLSCTX_ALL,
                IntPtr.Zero, out endpoint));
