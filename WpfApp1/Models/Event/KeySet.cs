...
{
    public override LogicalMouseWheelKey Create(int index) => new(index);
...
{
    public override PhysicalMouseWheelKey Create(int index) => new(logicalKeys[index], index);
...
{
    public override LogicalSystemKey Create(int index) => new(index);
...
{
    public override PhysicalSystemKey Create(int index) => new(logicalKeys[index], index);
...
{
    private static SupportedKeys Instance = new();
