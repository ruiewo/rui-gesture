...
{
    public override LogicalSingleThrowKey Create(int index) => new(index);
...
{
    public override PhysicalSingleThrowKey Create(int index) => new(logicalKeys[index], index);
...
{
    public override LogicalDoubleThrowKey Create(int index) => new(index);
...
{
    public override PhysicalDoubleThrowKey Create(int index) => new(logicalKeys[index], index);
