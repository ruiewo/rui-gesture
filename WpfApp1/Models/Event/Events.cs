namespace RuiGesture.Models.Event;
...
public abstract class Event : IEquatable<Event>
{
    ...
    public virtual bool Equals(Event that) => EventId == that.EventId;
...
{
    private static EventIdGenerator Instance = new();
...
public class LogicalFireEvent : FireEvent, ILogicalEvent
{
    ...
    public LogicalFireEvent(LogicalSingleThrowKey logicalKey) : base(EventIdGenerator.Generate())
    {
...
public class PhysicalFireEvent : FireEvent, IPhysicalEvent
{
    ...
    public LogicalFireEvent LogicalNormalized => LogicalKey.FireEvent;
...
public class LogicalPressEvent : PressEvent, ILogicalEvent
{
    ...
    public LogicalReleaseEvent Opposition => LogicalKey.ReleaseEvent;
...
public class LogicalReleaseEvent : ReleaseEvent, ILogicalEvent
{
    ...
    public LogicalPressEvent Opposition => LogicalKey.PressEvent;
...
public class PhysicalPressEvent : PressEvent, IPhysicalEvent
{
    ...
    public LogicalPressEvent LogicalNormalized => LogicalKey.PressEvent;

    public PhysicalReleaseEvent Opposition => PhysicalKey.ReleaseEvent;
...
public class PhysicalReleaseEvent : ReleaseEvent, IPhysicalEvent
{
    ...
    public LogicalReleaseEvent LogicalNormalized => LogicalKey.ReleaseEvent;

    public PhysicalPressEvent Opposition => PhysicalKey.PressEvent;
